...
func TestConfigValidation(t *testing.T) {
	...
	invalidCfg = DefaultConfig()
	invalidCfg.Audio.SilenceThreshold = 2.0 // Should be between 0 and 1
	err = invalidCfg.Validate()
	if err == nil {
		t.Error("Expected error for invalid silence threshold, got nil")
	}
